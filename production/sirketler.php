<?php
  ...
  $data2 = gelistirici_dagitici($baglan);
  ...
  $K_IP = $_SERVER['REMOTE_ADDR'];
	...
	$Islem = "Şirketler Sayfasını Ziyaret Etti";
	$card_num = null;
	$card_tarih = null;
	$card_cvc2 = null;
  $Tarayici = "";
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 ">
                    <div class="x_panel" style="background-color:#C9B6E4">
                      <div class="x_title">
                        <h2 style="color:black;">ŞİRKETLER</h2>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                          ...
                          <?php
                          $buttonStyle= "";
                              $dagiticiQuery = mysqli_query($baglan,"SELECT * FROM dagitici ");
                                if (mysqli_num_rows($dagiticiQuery)!=0){
                                  while($readDagitici = mysqli_fetch_array($dagiticiQuery)){
                                    $dagitici_ID = $readDagitici['dagitici_ID'];
                                    $dagitici_adi = $readDagitici['dagitici_adi'];
                                    $e_posta = $readDagitici['e-posta'];
                                    $deger = $readDagitici['deger'];
                                    $tarih = $readDagitici['tarih'];
                          ...
                          ?>
                            <tr style="text-align:left;">
                              <td style="text-align:center; vertical-align:middle"><?php echo $dagitici_adi ?></td>
                              ...
                              <?php if ($K_Tip == 2){
                                echo "<td style=\"text-align:center; vertical-align:middle\">
                                          <a href='sirketGuncelleme.php?&dagitici_ID={$dagitici_ID}' style='width:100px; font-size:12px;' class='btn btn-primary btn-xs'><i class='fa fa-search'></i> Düzenle </a>
                                          <a href='sirket_sil.php?&dagitici_ID={$dagitici_ID}' style='width:100px; font-size:12px;' class='btn btn-danger btn-xs'><i class='fa fa-pencil'></i> Sil </a>
                                      </td>";
                              } ?>
                            </tr>
                            <?php
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="dashboard_graph" style="background-color:#F0ECE5">
                      ...
                      <div class="row x_title">
                        <div class="col-md-6">
                          <h3 style="color:black">Şirketlerin Sattığı Oyun Sayısı</h3>
                        </div>
                      </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 ">
                    <div class="dashboard_graph" style="background-color:#F0ECE5">
                      ...
                      <div class="row x_title">
                        <div class="col-md-12">
                          <h3 style="color: black">Şirket - Oyun Geliştirici Firma Sayısı</h3>
                        </div>
                      </div>

                      <div class="col-md-12 col-sm-12 ">
                        <div id="grafik2" class="demo-placeholder"></div>
                      </div>
...
<!-- Oyuncu Sayısı Grafiği -->
  ...
  series: [
    ...
    var dagitici = [<?php echo "'" . implode("','", $data2['dagitici']) . "'"; ?>];
    var gelistirici = [<?php echo implode(",", $data2['gelistirici']); ?>];
    var myChart = echarts.init(dom, null, {
      renderer: 'canvas',
      useDirtyRect: false
    });
