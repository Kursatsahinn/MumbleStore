...
$oyunYuzdeleri = yuzdeler($baglan);
  ...
  $oyunlar = kullanici_oyunlar($baglan,$K_ID);
	...
	$Islem = "Oyunlar Sayfasını Ziyaret Etti";
	$card_num = null;
	$card_tarih = null;
	$card_cvc2 = null;
  $Tarayici = "";
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap"
                          ...
                          <thead>
                            <tr>
                              ...
                              <th style="text-align:center; vertical-align:middle"><?php echo $sutun ?></th>
                            </tr>
                          </thead>
                          <tbody>
                          <?php
                              ...
                              $oyunlarQuery = mysqli_query($baglan,"SELECT oyun.Oyun_ID ,oyun.Oyun_adi, gelistirici.Gelistirici_Ad, dagitici.dagitici_adi,kategori.Kategori_Tur,oyun.Oyun_fiyati,oyun.cikis_tarihi
                                ...
                                if (mysqli_num_rows($oyunlarQuery)!=0){
                                  while($readOyunlar = mysqli_fetch_array($oyunlarQuery)){
                                    ...
                                    if ($K_Tip == 2){
                                      $buton = "<td style=\"text-align:center; vertical-align:middle\">
                                          <a href='oyunGuncelleme.php?&oyun_ID={$oyun_ID}' style='width:100px; font-size:12px;' class='btn btn-primary btn-xs'><i class='fa fa-search'></i> Düzenle </a>
                                          <a href='oyun_sil.php?&oyun_ID={$oyun_ID}' style='width:100px; font-size:12px;' class='btn btn-danger btn-xs'><i class='fa fa-pencil'></i> Sil </a>
                                      </td>";

                                    }
                                    else {
                                            $buton = "<td style=\"text-align: center;\">
                                          <a href='satin_alim.php?oyun_ID={$oyun_ID}&user_ID={$K_ID}' style='width:100px; font-size:12px; background:green; border-color:green; {$buttonStyle}' class='btn btn-primary btn-xs'><i class='fa fa-shopping-cart'></i> Satın Al</a>
                                      </td>";
                                    }
                  ...
                  <div class="col-md-12 col-sm-12 ">
                    <div class="dashboard_graph" style="background-color:#F0ECE5">
                      ...
                      <div class="col-md-5 col-sm-5">
                        <div id="yuzdeler" class="demo-placeholder"></div>
                      </div>
                    ...
                    <div class="dashboard_graph" style="background-color:#F0ECE5">
                      ...
                      <div class="row x_title">
                        <div class="col-md-6" style="color:black">
                          <h3>Şirketlerin Sattığı Oyun Sayısı</h3>
                        </div>
