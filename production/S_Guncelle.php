<?php 
    ...
    $dagitici_ID = $_GET['dagitici_ID']; //İşlem yapılacak Kullanıcı ID
    $deger = $_GET['deger'];

    $sorgu = "UPDATE dagitici SET deger = '$deger' WHERE dagitici_ID = '$dagitici_ID'";
	...
	$Islem = "ID'si $dagitici_ID olan şirketin bilgilerini güncelledi.";
	$card_num = null;
	$card_tarih = null;
	$card_cvc2 = null;
    $Tarayici = "";
